...
# encoding: utf-8
'''
org.theseed.aurora.dupclean -- clean duplicates from a virus list file
...
''' % (program_shortdesc, str(__date__))
    ...
    try:
        ...
        parser.add_argument(dest="outFile", help="name of output file", metavar="outFile")
...
if __name__ == "__main__":
    ...
    if PROFILE:
        import cProfile
        import pstats
        profile_filename = 'org.theseed.aurora.dupclean_profile.txt'
